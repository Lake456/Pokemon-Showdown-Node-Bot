exports.translations = {
	commands: {
		...
		*/
		...
		tournament: {
			'e1': 'richiede il grado di moderatore (@) o superiore per creare il torneo',
			'e2': 'C\'è già un torneo nella room',
			'e31': 'Il formato',
			'e32': 'non è valido per i tornei',
			'e4': 'Il tempo di inizio non è valido',
			'e5': 'Autodq non valido',
			'e6': 'Numero massimo di giocatori non valido',
		...
		leaderboard: {
			...
			'tours': 'tour giocati',
			'bwon': 'lotte vinte',
			'not': 'La classifiche non è abilitata per la room',
			'empty': 'Non ci sono tornei registrati per la room',
			'table': 'Tabella classifica',
			'err': 'Errore di caricamento della classifica su Hastebin',
			'use': 'Usa',
			'confirm': 'conferma per resettare i dati leaderboars per room',
